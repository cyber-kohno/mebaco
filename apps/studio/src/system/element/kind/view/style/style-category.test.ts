...
describe('Style category', () => {
  it('stores a trimmed optional category without changing the Style identity', () => {
    const schema = StyleElement.createSchema()
