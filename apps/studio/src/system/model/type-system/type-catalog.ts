...
import type ObjectShape from '@system/model/type-system/object/object-shape'
...
import type ValueTypeDefinition from '@system/model/type-system/value-type-definition'
import ContentHost from '@system/model/element/content-host'
import ObjectPropertyTypeScriptMarker from '@system/model/type-system/object/object-property-typescript-marker'

namespace TypeCatalog {
  export const typeScriptNamespace = '$type'

  type ObjectElement = Extract<TreeNode.Node['element'], { kind: 'object-type' }>
  type UnionElement = Extract<TreeNode.Node['element'], { kind: 'union-type' }>
  type SignatureElement = Extract<TreeNode.Node['element'], { kind: 'signature-type' }>
