<script lang="ts">
  ...
  import FunctionCodeField from '../../ui/script/FunctionCodeField.svelte'
  import ValueSourceField from '../../ui/input/ValueSourceField.svelte'
  import ObjectShapeEditor from '../../element/kind/type/object/ObjectShapeEditor.svelte'
  import UnionDefinitionEditor from '../../element/kind/type/union/UnionDefinitionEditor.svelte'
  import SignatureDefinitionEditor from '../../element/kind/type/signature/SignatureDefinitionEditor.svelte'
  ...
  import type MonacoInjection from '../../ui/monaco/monaco-injection'
  ...
  import SignatureReferencePreview from '../../element/kind/type/signature/SignatureReferencePreview.svelte'
        ...
        if (result.verificationReset) {
          messages.push(
            result.verificationImpact.type === 'all'
              ...
              : 'Verification status reset: affected scope.',
          )
        }
