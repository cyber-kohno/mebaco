<script lang="ts">
  ...
  import ActionMenu from '@system/ui/action-menu/action-menu-controller'
  import { developInteractionStore } from '@system/workspace/interaction/state'
  import ElementTreeLabel from '@system/workspace/tree/label/ElementTreeLabel.svelte'
  ...
  import { TreeContextMenuResolver } from './context-menu'
