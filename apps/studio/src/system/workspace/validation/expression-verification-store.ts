...
import type { ExpressionVerificationImpact } from '@system/model/validation/expression/impact'

namespace ExpressionVerificationStore {
  export type Entry = {
    status: ExpressionVerification.Status
  ...
  ): ExpressionVerification.Status | null => {
  ...
  export const setResult = (
    node: TreeNode.Node,
    result: ExpressionVerification.Result,
  ) => {
